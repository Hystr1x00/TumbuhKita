...
export default function ModalTambahPosyandu({ open, onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center backdrop-blur-sm bg-white/30 transition-all duration-300 pt-20">
      ...
      >
        ...
        <h2 className="text-2xl font-extrabold mb-1">Tambah Posyandu Baru</h2>
        <p className="mb-6 text-neutral-600">Masukkan informasi lengkap posyandu yang akan didaftarkan dalam sistem.</p>
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block font-semibold mb-1">Nama Posyandu</label>
              <input name="namaPosyandu" value={form.namaPosyandu} onChange={handleChange} type="text" placeholder="Masukkan nama posyandu" className="w-full border rounded-lg px-4 py-2 outline-none" />
            </div>
            <div>
              <label className="block font-semibold mb-1">Kelurahan/Desa</label>
              <input name="kelurahan" value={form.kelurahan} onChange={handleChange} type="text" placeholder="Masukkan kelurahan/desa" className="w-full border rounded-lg px-4 py-2 outline-none" />
            </div>
            <div>
            ...
            <div>
              ...
              <input name="kabupaten" value={form.kabupaten} onChange={handleChange} type="text" placeholder="Masukkan kabupaten" className="w-full border rounded-lg px-4 py-2 outline-none" />
            </div>
            <div>
            ...
            <div>
              <label className="block font-semibold mb-1">Koordinat</label>
              <input name="koordinat" value={form.koordinat} onChange={handleChange} type="text" placeholder="Contoh: -6.978, 107.615" className="w-full border rounded-lg px-4 py-2 outline-none" />
            </div>
          </div>
          <div className="mb-4">
