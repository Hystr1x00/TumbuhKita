...
export default function ModalEditBalita({ open, onClose, balita, onSave }) {
  ...
  useEffect(() => {
    if (balita) {
      ...
      setFormData({
        nama: balita.nama || "",
        tglLahir: convertDateToInputFormat(balita.tglLahir),
        orangTua: balita.orangTua || "",
        usia: balita.usia || "",
        gender: balita.gender || "",
        berat: balita.berat?.replace(' kg', '') || "",
        tinggi: balita.tinggi?.replace(' cm', '') || "",
  ...
  const handleSubmit = (e) => {
    ...
    const dataToSave = {
      ...
      tglLahir: convertDateToIndonesianFormat(formData.tglLahir)
    };
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl p-8 w-full max-w-2xl relative shadow-lg
        ...
        <h2 className="text-2xl font-extrabold mb-1">Edit Data Balita</h2>
        <p className="mb-6 text-neutral-600">
          Edit informasi balita yang terdaftar dalam sistem.
        </p>
